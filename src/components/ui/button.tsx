  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-slate-600 bg-transparent text-slate-300 hover:bg-slate-700 hover:text-white focus-visible:ring-slate-500",
        secondary:
          "bg-slate-700 text-slate-200 shadow hover:bg-slate-600 focus-visible:ring-slate-500",
        ghost:
          "text-slate-300 hover:bg-slate-700 hover:text-white focus-visible:ring-slate-500",
